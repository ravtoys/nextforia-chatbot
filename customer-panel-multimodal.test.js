...
assert(adminHtml.includes('id="testDropOverlay"'));
assert(adminHtml.includes('id="testRecordingBar"'));
assert(adminHtml.includes('onclick="toggleTestRecording()"'));
assert(adminHtml.includes("navigator.mediaDevices.getUserMedia"));
assert(adminHtml.includes("new MediaRecorder"));
assert(adminHtml.includes('addEventListener("dragenter"'));
assert(adminHtml.includes('addEventListener("drop"'));
assert(!adminHtml.includes('id="testAudioFile"'));
