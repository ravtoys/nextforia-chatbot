...
duplicatedBothAnswers.operations.frequent_questions = "¿Atienden sin cita? Sí, según disponibilidad.";
...
duplicatedBothAnswers.customer_service_setup.brand_restrictions = "No dar diagnósticos ni prometer resultados.";
duplicatedBothAnswers.customer_service_setup.data_consent = true;
...
assert.strictEqual(normalizedBothAnswers.appointment_setup.business_hours, "Lunes a viernes de 8 a 5");
assert.strictEqual(normalizedBothAnswers.appointment_setup.forbidden_topics, "No dar diagnósticos ni prometer resultados.");
assert.strictEqual(normalizedBothAnswers.appointment_setup.faqs, "¿Atienden sin cita? Sí, según disponibilidad.");
assert.strictEqual(normalizedBothAnswers.appointment_setup.data_consent, true);
